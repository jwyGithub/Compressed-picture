...
import { setCellStyleFlags, setCellStyles, getSizeForString, } from '../../util/styleUtils';
...
export const CellsMixin = {
    ...
    cloneCell(cell, allowInvalidEdges = false, mapping = null, keepPosition = false) {
        return this.cloneCells(new CellArray(cell), allowInvalidEdges, mapping, keepPosition)[0];
    },
    /**
     ...
     */
    getCells(x, y, width, height, parent = null, result = new CellArray(), intersection = null, ignoreFn = null, includeDescendants = false) {
    ...
    isCellResizable(cell) {
        const style = this.getCurrentCellStyle(cell);
        const r = this.isCellsResizable() && !this.isCellLocked(cell) && (style.resizable ?? true);
        return r;
    },
    /**
