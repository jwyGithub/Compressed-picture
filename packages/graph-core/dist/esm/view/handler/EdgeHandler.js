...
class EdgeHandler {
    constructor(state) {
        ...
        const graphHandler = this.graph.getPlugin('SelectionHandler');
        // Creates bends for the non-routed absolute points
        // or bends that don't correspond to points
        if (this.graph.getSelectionCount() < graphHandler.maxCells ||
        ...
        class MyMarker extends CellMarker {
            constructor() {
                ...
                this.isValidState = (state) => {
                    const cell = self.state.cell.getTerminal(!self.isSource);
                    const cellState = self.graph.view.getState(cell);
    ...
    mouseUp(sender, me) {
        ...
        if (this.index != null && this.marker != null) {
            ...
            if (me.getX() !== this.startX || me.getY() !== this.startY) {
                let clone = !this.graph.isIgnoreTerminalEvent(me.getEvent()) &&
