 ...
 */
class SelectionChange {
    constructor(graph, added = new CellArray(), removed = new CellArray()) {
        this.graph = graph;
    ...
    execute() {
        ...
        this.graph.fireEvent(new EventObject(InternalEvent.CHANGE, { added: this.added, removed: this.removed }));
    }
}
