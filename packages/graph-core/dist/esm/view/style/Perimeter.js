...
class Perimeter {
     ...
     * returned.
     */
    static RectanglePerimeter(bounds, vertex, next, orthogonal = false) {
     ...
     */
    static EllipsePerimeter(bounds, vertex, next, orthogonal = false) {
        const { x } = bounds;
        const { y } = bounds;
     ...
     * for a description of the parameters.
     */
    static RhombusPerimeter(bounds, vertex, next, orthogonal = false) {
        const { x } = bounds;
        const { y } = bounds;
     ...
     * for a description of the parameters.
     */
    static TrianglePerimeter(bounds, vertex, next, orthogonal = false) {
     ...
     * for a description of the parameters.
     */
    static HexagonPerimeter(bounds, vertex, next, orthogonal = false) {
        const { x } = bounds;
        const { y } = bounds;
        const w = bounds.width;
        const h = bounds.height;
    ...
    static getValue(style, direction, DIRECTION_EAST) {
        return '';
    }
}
