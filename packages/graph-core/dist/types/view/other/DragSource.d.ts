...
export declare type DropHandler = (graph: Graph, evt: MouseEvent, cell: Cell | null, x?: number, y?: number) => void;
/**
 * @class DragSource
 *
...
declare class DragSource {
     ...
     */
    graphContainsEvent(graph: Graph, evt: MouseEvent): boolean;
    /**
     ...
     * Actives the given graph as a drop target.
     */
    dragEnter(graph: Graph, evt: MouseEvent): void;
    /**
     * Deactivates the given graph as a drop target.
     */
    dragExit(graph: Graph, evt?: MouseEvent): void;
    /**
     * Implements autoscroll, updates the {@link currentPoint}, highlights any drop
     * targets and updates the preview.
     */
    dragOver(graph: Graph, evt: MouseEvent): void;
    /**
     * Returns the drop target for the given graph and coordinates. This
     * implementation uses {@link mxGraph.getCellAt}.
     */
    drop(graph: Graph, evt: MouseEvent, dropTarget: Cell | null | undefined, x: number, y: number): void;
}
