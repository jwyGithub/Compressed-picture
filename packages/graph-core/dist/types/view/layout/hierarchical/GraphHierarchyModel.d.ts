...
declare class GraphHierarchyModel {
    constructor(layout: HierarchicalLayout, vertices: CellArray, roots: CellArray, parent: Cell, tightenToSource: boolean);
    /**
     ...
     */
    createInternalCells(layout: HierarchicalLayout, vertices: CellArray, internalVertices: {
