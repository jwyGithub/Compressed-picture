...
declare class SwimlaneLayout extends GraphLayout {
     ...
     */
    execute(parent: Cell, swimlanes?: CellArray | null): void;
    /**
     ...
     */
    traverse(vertex: Cell | null | undefined, directed: boolean, edge: Cell | null, allVertices: {
        [key: string]: Cell;
    } | null | undefined, currentComp: {
        [key: string]: Cell;
    }, hierarchyVertices: GraphHierarchyNode[], filledVertexSet: {
        [key: string]: Cell;
    } | null | undefined, swimlaneIndex: number): {
        [key: string]: Cell;
    };
    /**
