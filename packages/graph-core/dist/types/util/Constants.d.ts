 ...
 */
export declare const enum RENDERING_HINT {
    EXACT = "exact",
    FASTER = "faster",
    FASTEST = "fastest"
}
 ...
 */
export declare const enum DIALECT {
    SVG = "svg",
    MIXEDHTML = "mixedHtml",
 ...
 */
export declare const enum CURSOR {
    MOVABLE_VERTEX = "move",
    MOVABLE_EDGE = "move",
 ...
 */
export declare const enum ARROW {
    CLASSIC = "classic",
 ...
 */
export declare const enum TEXT_DIRECTION {
    DEFAULT = "",
    AUTO = "auto",
    LTR = "ltr",
    RTL = "rtl"
 ...
 */
export declare const enum EDGESTYLE {
 ...
 */
export declare const enum PERIMETER {
